...
class DeepAndCrossV6(nn.Layer):
    def __init__(self, config):
        ...
        self.senet = SqueezeExcitation(num_fields=self.num_fields, excitation_activation=self.excitation)
    ...
    def forward(self, features, mask):
        ...
        feat_embeddings = paddle.reshape(se_x, shape=[-1, self.num_fields * self.sparse_feature_dim])
